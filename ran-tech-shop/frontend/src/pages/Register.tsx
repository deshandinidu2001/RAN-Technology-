    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden py-20" style={{ backgroundColor: '#0A0A0B' }}>
      ...
      >
        ...
        <motion.div
          ...
          className="absolute -top-16 -left-16 w-32 h-32 border border-primary/20 rounded-full"
        />
        <motion.div
          animate={{
            rotate: -360,
          ...
          className="absolute -bottom-12 -right-12 w-24 h-24 border border-primary/10 rounded-full"
        />
      </motion.div>
    </div>
  );
