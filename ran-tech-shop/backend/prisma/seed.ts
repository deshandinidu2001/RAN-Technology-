...
async function main() {
  ...
  const componentProducts = [
    ...
    { id: 'gpu-101', name: 'NVIDIA GeForce RTX 4070 Super', brand: 'NVIDIA', price: 195000, image: 'https://images.unsplash.com/photo-1591488320449-011701bb6704?w=800&q=80', category: 'graphics-cards', subcategory: 'gpu', stock: 9, featured: true, description: '12GB GDDR6X graphics card — excellent 1440p performance with DLSS 3.', specs: { Memory: '12GB GDDR6X', Chipset: 'RTX 4070 Super', 'Boost Clock': '2475 MHz', 'Power Connector': '1× 16-pin' }, gpuMemory: 12, gpuChipset: 'RTX 4070 Super' },
    ...
    { id: 'cool-102', name: 'Noctua NH-D15', brand: 'Noctua', price: 38000, image: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=800&q=80', category: 'laptop-accessories', subcategory: 'cooling-pad', stock: 14, featured: true, description: 'Dual-tower premium air cooler — performance close to 240mm AIOs.', specs: { Type: 'Air', 'Fan Size': '2× 140mm', Sockets: 'AM5/AM4/LGA1700/1200' } },
    { id: 'cool-103', name: 'Arctic Liquid Freezer III 360', brand: 'Arctic', price: 42000, image: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=800&q=80', category: 'laptop-accessories', subcategory: 'cooling-pad', stock: 12, featured: false, description: '360mm AIO liquid cooler with VRM fan — exceptional thermal headroom.', specs: { Type: 'AIO', 'Radiator Size': '360mm' } },
    ...
    // ── POWER SUPPLIES ────────────────────────────────────────────
    { id: 'psu-101', name: 'Corsair RM850x 850W 80+ Gold', brand: 'Corsair', price: 48000, image: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=800&q=80', category: 'components', subcategory: 'psu', stock: 18, featured: true, description: 'Fully modular ATX PSU — quiet, efficient, 10-year warranty.', specs: { Wattage: '850W', Rating: '80+ Gold', Modularity: 'Fully Modular' } },
    ...
    { id: 'case-103', name: 'Corsair 4000D Airflow', brand: 'Corsair', price: 32000, image: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=800&q=80', category: 'components', subcategory: 'case', stock: 24, featured: false, description: 'High-airflow ATX mid-tower — community favorite for value builds.', specs: { 'Form Factor': 'ATX' } },
  ...
  const serviceItems = [
    ...
    { id: 'svc-003', name: 'Motherboard Diagnostics & Repair', serviceType: 'repair', price: 12000, image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=1600&q=80', description: 'Component-level motherboard repair — chip-level diagnosis, BGA reflow, capacitor replacement.', featured: true },
    ...
    { id: 'svc-006', name: 'Phone Screen Repair', serviceType: 'repair', price: 7500, image: 'https://images.unsplash.com/photo-1592434134753-a70baf7979d5?w=1600&q=80', description: 'Smartphone screen repair for all major brands — same-day service available.', featured: true },
    { id: 'svc-007', name: 'Monitor Repair', serviceType: 'repair', price: 5500, image: 'https://images.unsplash.com/photo-1547082299-de196ea013d6?w=1600&q=80', description: 'Dead pixels, backlight failures, power issues — fixed by certified technicians.', featured: false },
    ...
    { id: 'svc-103', name: 'Cooling Upgrade', serviceType: 'upgrade', price: 3500, image: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=1600&q=80', description: 'Better thermal management — premium thermal paste, new pads, fan replacement.', featured: true },
  ...
  await prisma.repairReview.deleteMany({});
  const repairReviews = [
    {
      serviceType: 'repair',
  ...
  for (const review of repairReviews) {
    await prisma.repairReview.create({ data: review });
  }
